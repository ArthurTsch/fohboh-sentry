...
export function deriveM02Calculation(
  ...
  return {
    ...
    deliveryCommissionableBasis: number("delivery_commissionable_basis_amount") || number("delivery_basis_amount"),
    ...
    pickupCommissionableBasis: number("pickup_commissionable_basis_amount") || number("pickup_basis_amount"),
    ...
    merchantFundedDiscount: number("merchant_funded_discount_amount"),
